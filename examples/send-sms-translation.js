...
const { NEXMO_API_KEY, NEXMO_API_SECRET, MSFT_API_KEY, FROM_NUMBER, TO_NUMBER } = require('../constants');
...
request.post(`https://api.cognitive.microsofttranslator.com/translate?api-version=3.0&to=${lang}`, options, (err, res, body) => {
    if (err) throw err;
